...
role_app_access = {
    "Developer": ["pycharm64.exe", "code.exe", "sublime_text.exe", "idea64.exe", "eclipse.exe"],
                ...
                if current_app != last_app:
                    ...
                    if current_app in app_access_limit and app_access_count[current_app] > app_access_limit[current_app]:
                        ...
                        supabase.table("Alerts").insert(
                            {"alert": f'The application {current_app} has been accessed more than {app_access_limit[current_app]} Times'}
                        ).execute()
